...
@
	Inside the functions in a class, @ is a variable for
...
composition
	The concept that a class can be composed of other
	classes as parts, much like how a car has wheels.	
attribute
	A property classes have that are from composition
	and are usually variables.
is-a
	A phrase to say that something inherits from another, 
	as in "salmon" is-a "fish".
has-a
	A phrase to say that something is composed of other things or
