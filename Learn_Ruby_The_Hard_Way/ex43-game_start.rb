...
class Scene
	def enter()
	puts "This scene is not yet configured. Subclass it and and implement enter()."
	exit(1)
	end
end
...
class CentralCorridor < Scene
		...
		def enter()
			...
			puts "Enter shoot!, dodge!, tell a joke!"
			print "> "
		...
		if action == "shoot!"
			...
			puts "Lbhe zbgurevf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf ne bhaq gur ubhfr"
